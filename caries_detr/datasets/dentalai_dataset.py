...
"""DentalAI dataset class for Caries-DETR.

The DentalAI dataset contains intraoral photographs annotated with four
object categories: Tooth, Caries, Cavity, and Crack.  Annotations follow
the standard COCO JSON schema.
"""
...
class DentalAIDataset(BaseDetDataset):
    """DentalAI intraoral photograph dataset (4 classes).
    ...
    METAINFO = {
        'classes': ('Tooth', 'Caries', 'Cavity', 'Crack'),
        'palette': [
            (220, 20, 60),
            (119, 11, 32),
            (0, 0, 142),
