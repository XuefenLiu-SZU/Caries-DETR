# Caries-DETR -- DentalAI 4-class configuration
...
#
# Usage:
#   python tools/train.py configs/caries_detr_dentalai.py
#   python tools/test.py  configs/caries_detr_dentalai.py <checkpoint>
#
...
custom_imports = dict(
    imports=['caries_detr.models.caries_detr_head',
             'caries_detr.datasets.dentalai_dataset'],
...
# Dataset
# -----------------------------------------------------------------------
dataset_type = 'DentalAIDataset'
data_root = 'data/DentalAI/'
backend_args = None
...
load_from = None
resume = False
work_dir = './work_dirs/caries_detr_dentalai'
